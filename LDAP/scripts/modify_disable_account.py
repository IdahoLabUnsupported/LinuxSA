...
if hasattr(user_entry_obj, 'shadowExpire'):
    ldap_obj.modify_ldap_attribute(conn, user_dn, user_entry_obj, 'shadowExpire', '0', args.userid)
else:
    ldap_obj.add_ldap_attribute(conn, user_dn, 'shadowExpire', '0', args.userid)
