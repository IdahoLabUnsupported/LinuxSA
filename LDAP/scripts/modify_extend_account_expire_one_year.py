...
ldap_time = next_year.strftime('%Y-%m-%d 00:00:00')
...
if hasattr(user_entry_obj, 'accountEndDate'):
    ldap_obj.modify_ldap_attribute(conn, user_dn, user_entry_obj, 'accountEndDate', ldap_time, args.userid)
else:
    ldap_obj.add_ldap_attribute(conn, user_dn, 'accountEndDate', ldap_time, args.userid)
